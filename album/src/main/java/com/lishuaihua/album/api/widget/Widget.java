package com.lishuaihua.album.api.widget;
...
public class Widget implements Parcelable {
    ...
    private Widget(Builder builder) {
        ...
        this.mNavigationBarColor = builder.mNavigationBarColor == 0 ?
                ContextCompat.getColor(mContext, R.color.ColorPrimaryBlack) : builder.mNavigationBarColor;
        this.mTitle = TextUtils.isEmpty(builder.mTitle) ? mContext.getString(R.string.title) : builder.mTitle;
        this.mMediaItemCheckSelector = builder.mMediaItemCheckSelector == null ?
                AlbumUtils.getColorStateList(ContextCompat.getColor(mContext, R.color.WhiteGray),
    ...
    public static Widget getDefaultWidget(Context context) {
        return Widget.newDarkBuilder(context)
                ...
                .navigationBarColor(ContextCompat.getColor(context, R.color.ColorPrimaryBlack))
                .title(R.string.title)
                .mediaItemCheckSelector(ContextCompat.getColor(context, R.color.WhiteGray),
                        ContextCompat.getColor(context, R.color.ColorPrimary))
                .bucketItemCheckSelector(ContextCompat.getColor(context, R.color.WhiteGray),
                        ContextCompat.getColor(context, R.color.ColorPrimary))
                .buttonStyle(
